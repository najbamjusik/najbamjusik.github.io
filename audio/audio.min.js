(function (h, o, g) {
    ...
    g[h] = {
        ...
        settings: {
            ...
            createPlayer: {
                markup: '          <div class="play-pause">             <p class="play">pause</p>             <p class="pause" id="player-button">ODPALAMY NUMER CLICNIJ TU</p>                        <p class="error">error</p>           </div>           <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>           <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>           <div class="error-message"></div>',
            ...
            pause: function () {
                ...
                g[h].helpers.removeClass(this.wrapper, this.settings.createPlayer.pausedClass)
            },
